...
const AddressDetails = ({ handleNext }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <p className="text-xl font-poppins font-bold uppercase text-center">
        Choose an option
      </p>
      <p className="text-sm text-black/70 text-center">
        Choose an option below to select your delivery method
      </p>
        ...
        <p
          className={`${
            orderType === "delivery"
              ...
              : "text-black/50 hover:bg-mainBg/20"
          } cursor-pointer font-normal  h-full px-3 py-3 rounded-full`}
        ...
        {orderType === "delivery" ? (
          ...
          <>
            ...
            >
              <div className="flex flex-col gap-1">
                <textarea
                  placeholder="Do you have any message for us? (Optional)"
                  rows={5}
                  {...register("orderNotes")}
              ...
              <button
                className="cursor-pointer w-full bg-mainRed/90 text-white rounded-full py-3 text-lg font-normal flex items-center justify-center gap-1 hover:gap-2 transition-all duration-200"
                value="submit"
                type="submit"
              >
                Next{" "}
