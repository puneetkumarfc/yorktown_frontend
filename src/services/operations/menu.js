...
const { FETCH_MENU, FETCH_CATEGORIES, ITEM_DETAILS, FETCH_CATEGORIES_COPY, PROMO_CODE} = menuEndpoints;

export const fetchCategories = async(displayHome) => await apiConnector("GET", FETCH_CATEGORIES(displayHome));
export const fetchCategoriesCopy = async(categoryId, displayHome) => await apiConnector("GET", FETCH_CATEGORIES_COPY(categoryId, displayHome));
